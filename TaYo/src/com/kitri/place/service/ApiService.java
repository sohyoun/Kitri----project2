...
public class ApiService {
	...
	public StringBuilder getUrl(String cmd, String numOfRows) {
		...
		try {
			...
			// public static final String TOUR_APIURL =
...
//	        System.out.println("TourResionCodeService Response code: " + conn.getResponseCode());
	...
	public String getcat2(String contentTypeId, String cat1 ) throws IOException {
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("cat1","UTF-8") + "=" + URLEncoder.encode(cat1, "UTF-8")); /*대분류코드*/
	        URL url = new URL(urlBuilder.toString());
	        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
	        conn.setRequestMethod("GET");
	        conn.setRequestProperty("Content-type", "application/json");
	...
	public String getcat3(String contentTypeId, String cat1, String cat2 ) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("contentTypeId","UTF-8") + "=" + URLEncoder.encode(contentTypeId, "UTF-8")); /*관광타입(관광지, 숙박 등) ID*/
        urlBuilder.append("&" + URLEncoder.encode("cat1","UTF-8") + "=" + URLEncoder.encode(cat1, "UTF-8")); /*대분류코드*/
        urlBuilder.append("&" + URLEncoder.encode("cat2","UTF-8") + "=" + URLEncoder.encode(cat2, "UTF-8")); /*중분류코드(cat1필수)*/
        URL url = new URL(urlBuilder.toString());
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("GET");
        conn.setRequestProperty("Content-type", "application/json");
...
//		/* StringBuilder strB = this.getUrl(cmd, "20"); */
//		strB.append("&" + URLEncoder.encode("contentTypeId", "UTF-8") + "=" + URLEncoder.encode(contentTypeId, "UTF-8"));
//		strB.append("&" + URLEncoder.encode("cat1","UTF-8") + "=" + URLEncoder.encode(cat1, "UTF-8")); /*대분류코드*/
//		URL url = new URL(strB.toString());
//		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
//		conn.setRequestMethod("GET");
//		conn.setRequestProperty("Content-type", "application/json");
...
//	}
	...
	public String getcat3(String cmd, String contentTypeId, String cat1, String cat2 ) throws IOException {
		StringBuilder strB = this.getUrl(cmd, "20");
		
		strB.append("&" + URLEncoder.encode("contentTypeId", "UTF-8") + "=" + URLEncoder.encode(contentTypeId, "UTF-8"));
		strB.append("&" + URLEncoder.encode("cat1","UTF-8") + "=" + URLEncoder.encode(cat1, "UTF-8")); /*대분류코드*/
		strB.append("&" + URLEncoder.encode("cat2","UTF-8") + "=" + URLEncoder.encode(cat2, "UTF-8")); /*대분류코드*/
		URL url = new URL(strB.toString());
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		conn.setRequestMethod("GET");
		conn.setRequestProperty("Content-type", "application/json");
	...
	public String getSearch(String cmd, HttpServletRequest request) throws Exception {
		...
		strB.append("&" + URLEncoder.encode("bgnde", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("bgnde"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("endde", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("endde"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("upkind", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("upkind"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("kind", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("kind"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("upr_cd", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("upr_cd"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("org_cd", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("org_cd"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("care_reg_no", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("care_reg_no"), "UTF-8"));
		strB.append("&" + URLEncoder.encode("pageNo", "UTF-8") + "="
				+ URLEncoder.encode(request.getParameter("pageNo"), "UTF-8"));
