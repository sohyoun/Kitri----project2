...
public class PlaceService {
	...
	public String getKeywordSearch(String sido) throws IOException {
		...
		urlString.append("areaCode="+Integer.parseInt(sido)+"&");				// 지역코드
		/*
		 * urlString.append("keyword="+URLEncoder.encode((place).trim(), "UTF-8")); //
		 * 검색할 키워드 (한글인 경우 UTF-8 인코딩 필수)
		 */		
