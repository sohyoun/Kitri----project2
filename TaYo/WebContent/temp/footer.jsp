...
<section class="text-content">
	<div class="overlay-inner py-5">
		<div class="container py-md-3">
			<div class="test-info">
				<h4 class="tittle">Enjoy Tayo in Mobile</h4>
				<p class="mt-3">모바일에서도 타요타요를 즐겨보세요!</p>
			...
			<div class="col-lg-3 col-sm-6 footer-grid_section_1its_w3">
				...
				<div class="row">
					<ul class="col-6 links">
						...
						<li><a href="${pageContext.request.contextPath}/schedule?act=schedule" class="scroll">일정 만들기</a></li>
						<li><a href="${pageContext.request.contextPath}/tayotogether/tayotogether.jsp" class="scroll">함께타요</a></li>
